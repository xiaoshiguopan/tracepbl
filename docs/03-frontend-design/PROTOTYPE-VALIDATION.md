...
7. 2026-09-01 修订为项目全程无声；5—7 秒动画可以存在，但不能阻止用户一次点击进入或使用。
...
12. 认可光线回应但不做信息热点/寻物游戏；采用无声的洞窟灯火、衣料、纸页和残卷空间运动。
...
| 检查 | 结果 | 限制/修订 |
|---|---|---|
| P00 第一眼层级 | 标题、年份、唯一主动作、常驻演示边界和艺术声明清晰；电影画面未覆盖文字 | 静态稿已于 2026-09-01 同步；动态质量以运行页面复验 |
...
| 混合 3D 镜头设计 | 用户逐项确认人物、镜头、流散、转场、交互、无声、再次访问和降级 | 阶段 6 已有运行实现；最终表现以最新 P00/P01 联动验证记录为准 |
