...
> 状态：阶段 5 已批准归档
> 当前修订：2026-09-02 P08 与“最终确认与导出”合并流程已在阶段 6.10 同步，等待归档
...
入口 P08 完成 → P09“最终确认与导出”。P09 按问题、史料、活动、支架、量规分组，教师逐项确认/退回/编辑；确认前显示事实摘要，不预勾选。全部满足后在同一页面继续预览许可替代和文件内容，再生成本地副本。原 P10 不再是独立页面或步骤。
